<template>
  <div class="settings-layout">
    ...
    <div class="settings-actions">
      <button class="btn btn-secondary" @click="exportAllSettings" :disabled="saving">
        <i class="fas fa-download"></i> Export All Settings
      </button>
      <button class="btn btn-secondary" @click="importSettings" :disabled="saving">
        <i class="fas fa-upload"></i> Import Settings
      </button>
      <button class="btn btn-danger" @click="resetAllSettings" :disabled="saving">
